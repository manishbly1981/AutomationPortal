...
public interface TestStepService {
    ResponseEntity<String> addTestSteps(String email, String projectName, String moduleName, String testCaseName, List<TestStep> testSteps);
    ResponseEntity<String> editTestSteps(String email, String projectName, String moduleName, String testCaseName, List<TestStep> testSteps);
